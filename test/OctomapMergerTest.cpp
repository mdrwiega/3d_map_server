...
TEST_F(OctomapMergerTest, transformOcTree_TranslationOnly)
{
  ...
  auto transformedTree = merger.transformOctree(tree, transform);
...
TEST_F(OctomapMergerTest, transformOcTree_TranslationAndRotation)
{
  constexpr float res = 0.1;
  OcTree tree(res);
  tree.setNodeValue(0.05, 0.05, 0.05, 0.6);
